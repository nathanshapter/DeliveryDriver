...
public class TopDownCarController : MonoBehaviour
{
    ...
    public float driftFactorOriginal = .95f, accelerationFactorOriginal = 15f, maxSpeedOriginal = 20f;
    public float driftFactorDamaged = .2f, accelerationFactorDamaged = 7f, maxSpeedDamaged = 10f;

    public float driftFactorBrake = 10f;
    ...
    {
        accelerationFactor = accelerationFactorDamaged;
        maxSpeed = maxSpeedDamaged;
    }
    public void CarOriginalSpeed()
    {
        driftFactor = driftFactorOriginal;
        accelerationFactor = accelerationFactorOriginal;
    ...
    void FixedUpdate()
    {
        if(driver.gas >= 0 || arcadeMode == true)
        {
